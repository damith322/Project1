...
function my_plugin_options() {
    ...
    echo '<div class="wrap">';
    echo '<p>Select Your Post and Clone IT</p>';
    echo '</div>';
...
function rd_duplicate_post_link( $actions, $post ) {
	if (current_user_can('edit_posts')) {
		$actions['duplicate'] = '<a href="admin.php?action=rd_duplicate_post_as_draft&amp;post=' . $post->ID . '" title="Duplicate this item" rel="permalink">clone</a>';
	}
	return $actions;
}
 ...
 */
function duplicate_post_clone_post_link( $link = null, $before = '', $after = '', $post_id = 0 ) {
