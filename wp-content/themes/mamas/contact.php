<?php 
	...
	#Your e-mail address
	define("__TO__", "damith@thesanmark.com");
			...
			<body>
			  <table style="width: 500px; font-family: arial; font-size: 14px;" border="1">
				<tr style="height: 32px;">
				  ...
				  <td align="left" style="padding-left:5px; line-height: 20px;">'. $name .'  '.$lname .'</td>
				</tr>
				<tr style="height: 32px;">
				...
				<tr style="height: 32px;">
				  ...
				  <td align="left" style="padding-left:5px; line-height: 20px;">'. $phonnumber .'</td>
				</tr>
				<tr style="height: 32px;">
